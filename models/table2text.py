...
class Table2Text(Model):
    ...
    def __init__(self, 
        ...
        self.decoder = rnn.rnn_decoder(emb_size, hidden_size, dec_layers, dropout, 'tanh')
    ...
    def forward(self,
                ...
                lpos: Dict[str, torch.Tensor]=None,
                rpos: Dict[str, torch.Tensor]=None) -> Dict[str, torch.Tensor]:
    ...
    def predict(self, 
        ...
        with torch.no_grad(): 
            if self.beam_size == 1:
                return self.greedy_search(src, key, lpos, rpos, self.max_decoding_step)
            else:
                return self.beam_search(src, key, lpos, rpos, self.max_decoding_step)
