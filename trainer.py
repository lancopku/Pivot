...
class Trainer(Registrable):
    ...
    def rescale_gradients(self) -> Optional[float]:
        ...
        if self._grad_norm:
            if self.fp16:
                return self.optimizer.clip_master_grads(self._grad_norm)
            else:
                return sparse_clip_norm(self.model.parameters(), self._grad_norm)
        return None
    ...
    def _train_epoch(self, epoch: int) -> Dict[str, float]:
        ...
        #TODO: subset
        train_generator_tqdm = Tqdm.tqdm(self.train_loader, total=num_training_batches)
